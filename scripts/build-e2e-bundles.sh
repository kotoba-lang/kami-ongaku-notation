...
# 2026-07-12)") and kami-ongaku-sampler's own scripts/build-e2e-bundles.sh
# for the full empirical derivation, including what was tried and rejected
# (a manual `(set! (.-x js/goog.global) f)` instead of `^:export` -- NOT
# safe against Closure's DCE).
#
